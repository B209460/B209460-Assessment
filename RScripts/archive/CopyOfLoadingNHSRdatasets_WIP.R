...
#This script will load the the NHS England accident and emergency attendances and admissions (ae_attendances) dataset from the NHSRdatasets package. 
...
#and save it to the project ‘RawData’ folder. It will then examine the four-hour waiting time target performance for England as a whole, 
#selecting a subset of the variables needed. 
#It will then partitioned the data subset into training and testing data and save them to the project working ‘Data’ folder, 
